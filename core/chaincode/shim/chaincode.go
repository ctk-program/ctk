...
// GetSuperMiner documentation can be found in interfaces.go
func (stub *ChaincodeStub) GetSuperMiner() string {
	//todo
	return ""
}

// GetNormalMiner documentation can be found in interfaces.go
func (stub *ChaincodeStub) GetNormalMiner() string {
	//todo
	return ""
}

// GetPoolMiner documentation can be found in interfaces.go
func (stub *ChaincodeStub) GetPoolMiner() string {
	//todo
	return ""
}
