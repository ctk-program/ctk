...
func Load() (*TopLevel, error) {
	config := viper.New()
	err := coreconfig.InitViper(config, "orderer")
	if err != nil{
		fmt.Println("=================InitViper===============",err)
	}
	...
	fmt.Println("=================config.get()===============",config.ConfigFileUsed())
	if err := config.ReadInConfig(); err != nil {
		fmt.Println("=================config.ReadInConfig()===============",err)
	...
	fmt.Println("=================config.ConfigFileUsed()===============",config.ConfigFileUsed())
